...
ThemeData _lightTheme(AppThemePalette palette) {
  return ThemeData(
    ...
    progressIndicatorTheme: ProgressIndicatorThemeData(
      ...
      refreshBackgroundColor: palette.primaryColor.withValues(alpha: 0.1),
    ...
    textButtonTheme: TextButtonThemeData(
      style: ButtonStyle(
        ...
        shape: RoundedRectangleBorder(borderRadius: 6.cl(5, 16).rc.brAll).all,
      ),
    ),
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: ButtonStyle(
        ...
        elevation: 0.0.all,
        foregroundColor: palette.primaryColor.all,
        surfaceTintColor: palette.background.all,
        iconColor: palette.primaryColor.all,
        textStyle: TextStyle(
        ...
        padding: 10.cl(12, 20).pdXY(5.cl(5, 10)).all,
        shape: RoundedRectangleBorder(
          borderRadius: 6.cl(5, 16).rc.brAll,
